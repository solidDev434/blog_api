...
| `GET`    | `/api/v1/author_profiles`          | List author profile                   | Public                             |
| `GET`    | `/api/v1/author_profiles/me`       | Get own author profile                | Author/Editor                      |
...
| `GET`    | `/api/v1/author_profile/{user_id}` | Get specific author's public profile  | Public                             |
