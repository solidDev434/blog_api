...
| `GET`    | `/api/v1/author_profile`             | List author profile                   | Public                             |
| `GET`    | `/api/v1/author_profile/me`          | Get own author profile                | Author/Editor                      |
| `POST`   | `/api/v1/author_profile/me`          | Create author profile                 | Author/Editor                      |
| `PATCH`  | `/api/v1/author_profile/me`          | Update own author profile             | Author/Editor                      |
| `GET`    | `/api/v1/author_profile/{author_id}` | Get specific author's public profile  | Public                             |
...
| `PATCH`  | `/api/v1/posts/{id}`                 | Update post                           | Author (Post owner)                |
| `DELETE` | `/api/v1/posts/{id}`                 | Delete post                           | Author (Post owner)                |
| `POST`   | `/api/v1/posts/{id}/draft`           | Draft post                            | Author (Post owner)                |
| `POST`   | `/api/v1/posts/{id}/publish`         | Publish a draft                       | Author (Post owner)                |
| `POST`   | `/api/v1/posts/{id}/unpublish`       | Revert post to draft                  | Author (Post owner) or Admin       |
| `GET`    | `/api/v1/posts/me`                   | My posts                              | Author                             |
| `GET`    | `/api/v1/posts/{id}/analytics`       | Post analytics                        | Author (Post owner)                |
| `GET`    | `/api/v1/posts/{id}/comments`        | List comments                         | Public                             |
| `POST`   | `/api/v1/posts/{id}/comments`        | Add comment                           | Required                           |
| `DELETE` | `/api/v1/comments/{id}`              | Delete comment                        | Comment owner, post owner or Admin |
| `GET`    | `/api/v1/users/me`                   | Get own profile                       | Required                           |
| `PATCH`  | `/api/v1/users/me`                   | Update profile                        | Required                           |
| `GET`    | `/api/v1/admin/users`                | List all users                        | Admin                              |
| `PATCH`  | `/api/v1/admin/users/{id}/role`      | Change a user's role (promote/demote) | Admin                              |
